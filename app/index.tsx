...
export default function App() {
    ...
    useEffect(() => {
        if (Platform.OS === "android") {
            const backHandler = BackHandler.addEventListener("hardwareBackPress", backPressCallback);
    ...
    const showCover = !initialLoadComplete && loading && !showLoader && !showAutoLoader && !loaderFinished;
    ...
    return (
        <>
            ...
            {showLoader && !showAutoLoader && <Loader onFinish={handleLoaderFinish} />}
